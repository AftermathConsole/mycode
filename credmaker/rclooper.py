...
# open our csv data ( we ant to loop across this)
with open("csv_users.txt", "r") as csvfile:
    # counter to create unique file name
    i = 0
    # loop across our open file line by line
    for row in csv.reader(csvfile):
        i = i + 1 # increase i by 1 (to create unique admin.rc file name)
        filename = f"admin.rc{1}" # this f string says, "fill in the value of i"

        # open a file via "with". This file will autoclose when the indentions stop
