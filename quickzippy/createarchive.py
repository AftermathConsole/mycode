...
import os # low-level, operating system agnostic commands
import zipfile # tools to create, read, write, appened and list a ZIP file.
...
def zipdir(dirpath, zipfileobj):
    ...
    # so the following line destructures what we get from os.walk
...
def main():
    """called at runtime"""
    # ask the user for the directory to be archived.
